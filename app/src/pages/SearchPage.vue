<template>
  <div class="main-screen">
    <img class="main-yt-image" src="~assets/images/youtube-phone.png" />
    <div>
      <div>
        <legend class="main-legend q-mb-xl">
          Get your own video from Youtube
        </legend>
      </div>
...
export default {
  ...
  methods: {
    doSearch() {
      this.$router.push("/main?q=" + this.videoUrl);
    },
    enterKey(evt) {
      if (evt.key === "Enter") {
        this.doSearch();
